return function (connection, req, args)
    ...
    elseif req.method == "POST" then
		...
		file.writeline('mqtt={}')
		file.writeline('mqtt.sensor_name="' .. tostring(rd.sensor_name) .. '"')
		file.writeline('mqtt.broker_ip="' .. tostring(rd.mqtt_broker_ip) .. '"')
		file.writeline('mqtt.broker_port=' .. tostring(rd.mqtt_broker_port) )
		file.writeline('mqtt.username="' .. tostring(rd.mqtt_username) .. '"')
		file.writeline('mqtt.password="' .. tostring(rd.mqtt_password) .. '"')
		file.writeline('return mqtt')
		file.close()
